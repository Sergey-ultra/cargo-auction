...
function LoadForm() {
    ...
    const fillLoadFloat = e => setLoad({...load, [[e.target.name]]: Number.parseFloat(e.target.value)});
    const setFromCity = cityObj => setLoad({...load, fromCityId: cityObj.id});
    const setToCity = cityObj => setLoad({...load, toCityId: cityObj.id});
                ...
                <form name="load" onSubmit={saveLoad}>
                            ...
                            <div>
                                ...
                                <div className="input">
                                    <TextField sx={{m:1, minWidth: 300}} type="number" name="volume" size="small"
                                               label="Объём (на одну машину)" value={load.volume} onChange={fillLoadFloat}/>
                                </div>
                                <div className="input">
                                    <TextField sx={{m:1, minWidth: 300}} type="number" name="weight" size="small"
                                               label="Вес (на одну машину)" value={load.weight} onChange={fillLoadFloat}/>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="fieldset">
                        <div className="form-item">
                            ...
                            <div className="input">
                                <DatePicker value={load.downloadingDate} onChange={value => setLoad({...load, downloadingDate: value})} />
                            </div>
                            <div className="input">
                    ...
                    <div className="fieldset">
                        <div className="form-item">
                            ...
                            <div className="input">
                                <AutocompleteAddress
                                    value={load.fromCityId}
                                    setCityObject={setFromCity}
                                    label="Населенный пункт"/>

                            </div>
                            <div className="input">
                                <TextField name="fromAddress" size="small" value={load.fromAddress}
                        ...
                        <div className="form-item">
                            ...
                            <div className="input">
                                <TextField name="toAddress" size="small" value={load.toAddress}
                                           placeholder="Адрес в населенном пункте"
                                           onChange={fillLoad}/>
                            </div>
                        </div>
