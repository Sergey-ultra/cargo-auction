...
function TransportItem({truck, openSendBidModal, openAuthModal}) {
    ...
    return (
        ...
        //                             <span className="text-bold">{load.priceWithoutTax} руб</span>
        //                             <span className="text-gray"> без НДС </span>
        //                             <span className="text-bold">{(load.priceWithoutTax / load.distance).toFixed(2)}</span> руб/км
        //                         </div>)}
        //
        //                     {load.priceWithTax &&
        //                         (<div className="price__item">
        ...
        //                             <span className="text-bold">{(load.priceWithTax / load.distance).toFixed(2)}</span> руб/км
        //                         </div>)}
        //                 </div>
