...
final class Version20231219182908 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE orders (id INT NOT NULL, user_id INT NOT NULL, to_address VARCHAR(255) NOT NULL, to_latitude DOUBLE PRECISION DEFAULT NULL, to_longitude DOUBLE PRECISION DEFAULT NULL, from_address VARCHAR(255) NOT NULL, from_latitude DOUBLE PRECISION DEFAULT NULL, from_longitude DOUBLE PRECISION DEFAULT NULL, weight VARCHAR(255) NOT NULL, volume VARCHAR(255) NOT NULL, price_type VARCHAR(50) NOT NULL, price_without_tax INT DEFAULT NULL, price_with_tax INT DEFAULT NULL, cargo_type INT NOT NULL, body_type INT NOT NULL, downloading_type INT NOT NULL, unloading_type INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
